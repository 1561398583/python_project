...
class Test1(unittest.TestCase):
    ...
    def test_qcc(self):
        ...
        r = qcc.getOnePageData(5)
        print(r)
        f = open('E:\\python_work\\find_company\\companyInfos', "a")
        for item in r:
            s = 'companyName: ' + item['companyName'] + ', bossName: ' + item['bossName'] + ', addr: ' + item['addr'] + ', status: ' + item['status'] + ', during: ' + item['during'] + ', businessScope: ' + item['businessScope'] + "\n"
            f.write(s)
        f.close()
